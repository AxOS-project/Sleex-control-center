...
class ArgParse:
    ...
    def print_help_msg(self, stream: Optional[TextIO]):
        ...
        # Header
        self.arg_print(f"\n{BOLD}{CYAN}╭────────────────────────────────────────────────────────────────╮{RESET}")
        self.arg_print(f"{BOLD}{CYAN}│                       Sleex Control Center                       │{RESET}")
        self.arg_print(f"{BOLD}{CYAN}╰────────────────────────────────────────────────────────────────╯{RESET}\n")

        # Usage
        self.arg_print(f"{BOLD}USAGE:{RESET}")
        self.arg_print(f"  {WHITE}sleex-control {GRAY}[options]{RESET} \n  {WHITE}control {GRAY}[options]\n")
        ...
        # Footer
        self.arg_print(f"{BOLD}{CYAN}╭────────────────────────────────────────────────────────────────╮{RESET}")
        self.arg_print(f"{BOLD}{CYAN}│                  https://www.axos-project.com                  │{RESET}")
        self.arg_print(f"{BOLD}{CYAN}╰────────────────────────────────────────────────────────────────╯{RESET}\n")

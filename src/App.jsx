        ...
        <div className="settings-grid">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("workspace_swipe_direction_lock", e.target.checked)
              }
            />
          </div>
        ...
        <div className="settings-grid">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleChange("allow_tearing", e.target.checked)}
            />
          </div>
        </div>
        <div className="settings-grid">
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleChange("preserve_split", e.target.checked)}
            />
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleChange("smart_resizing", e.target.checked)}
            />
          </div>
        </div>
        <div className="settings-grid">
        ...
        <div className="settings-grid">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => handleChange("enable_swallow", e.target.checked)}
            />
          </div>
        ...
        <div className="settings-grid">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("plugin_hyprexpo_workspace_method", e.target.value)
              }
            />
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("plugin_hyprexpo_enable_gesture", e.target.checked)
              }
            />
          </div>
